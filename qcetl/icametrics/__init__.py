        ...
        self.schema_versions = {
            1: {
                "icametrics": {
                    ...
                    Column.Project: "s",
                    Column.DeID: "s",
                    Column.MeanCovGenome: "qf",
                    Column.MeanCovFull: "qf",
                    Column.MeanCovSub: "qf",
                    Column.FailedRegion: "qf",
                    Column.PctGenome: "qf",
                    Column.UniCov: "qf",
                    Column.Sex: "s",
                    Column.ObsSex: "s",
                    Column.PctMapped: "qf",
                    Column.PctUnique: "qf",
                    Column.MeanInsertLength: "qf",
                    Column.MedInsertLength: "qf",
                    Column.TiTvRatio: "qf",
                    Column.PctAutosome: "qf",
                    Column.CovUni: "qf",
                    Column.DupDelRatio: "qf",
                }
            }
        }
