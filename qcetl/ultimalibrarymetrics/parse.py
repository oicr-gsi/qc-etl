...
def parse_records(data, barcode):
    ...
    row = {
        ...
        Column.PercentPFHQAligned: float(qtable.get("PCT_PF_HQ_aligned")),
        Column.MedianReadLength: float(qtable.get("Median_Read_Length")),
        Column.PercentFailedQCReads: float(qtable.get("PCT_Failed_QC_reads")),
        Column.PercentPFReadsAligned: float(qtable.get("PCT_PF_Reads_aligned")),
