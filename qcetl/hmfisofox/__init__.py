...
from qcetl.hmfisofox.parse import parse_record


class HmfIsofoxCache(qcetl.common.Cache):
    """
    RNA QC metrics from hmftools Isofox, run on a merged/call-ready RNA BAM.
    One build record points at the ``*.isf.summary.csv`` file.
    """
